    ...
    <div className={aiInvoiceModalStyles.overlay}>
        ...
        <div className={aiInvoiceModalStyles.modal}>
            <div className="flex items-start justify-between">
                <div>
                    ...
                    <p className={aiInvoiceModalStyles.description}>
                        Paste any text that contains invoice details (client, items, quantities, prices) and we'll attempt to extract an invoice.
                    </p>
                </div>
            ...
            <div className='mt-4'>
                ...
                <textarea value={text} onChange={(e) => setText(e.target.value)} placeholder={`eg. A person  wants a logo design for her organic brand "GreenVibe." Quoted for $120 2 logo options and final delivery in PNG and vector format`} rows={8} className={aiInvoiceModalStyles.textarea}></textarea>
            </div>
            {error && (
